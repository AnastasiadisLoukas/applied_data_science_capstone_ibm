...
app.layout = html.Div(children=[html.H1("Louka's SpaceX Launch Records Dashboard",
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(values=site_success_counts, 
        ...
        failure_count = filtered_data[filtered_data['class'] == 0].shape[0]
